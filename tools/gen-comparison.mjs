...
const ROWS = [
  ...
  null,
  { cap: ['Arabic shaping + RTL'], cells: [g('built in'), n('—'), n('—'), n('not RTL-designed (docs)')] },
  { cap: ['MTEXT inline codes, MIF,', '\\U+ escapes'], cells: [g('full'), n('—'), n('—'), a('full parser; no MIF')] },
  { cap: ['Every DWG codepage'], cells: [g('yes'), g('yes'), n('—'), n('—')] },
  null,
  { cap: ['SVG / PDF / GeoJSON export'], cells: [g('all three, built in'), a('GeoJSON only'), a('SVG only'), g('all three, via add-ons')] },
  { cap: ['Hatch pattern explosion'], cells: [g('yes'), n('—'), n('—'), g('yes')] },
